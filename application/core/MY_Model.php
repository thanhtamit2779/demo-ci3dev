...
class MY_Model extends CI_Model
{
    ...
    function __call($name, $arguments)
    {
        ...
        {
            throw new BadMethodCallException('No such method: '.$name.'() in class '.get_class($this));
        }
    }
    /* --------------------------------------------------------------
     * CRUD INTERFACE
    ...
    public function get_all()
    {
        ...
        if (isset($this->after_get) && is_array($this->after_get) && !empty($this->after_get))
        {
    ...
    public function update_by()
    {
        ...
        if ($this->validate($data) !== FALSE)
        {
            ...
            $result = $this->_database->set($data)
                               ->update($this->_table);
            $this->trigger('after_update', array($data, $result, $args));
